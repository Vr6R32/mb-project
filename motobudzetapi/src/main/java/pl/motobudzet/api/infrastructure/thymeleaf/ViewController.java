...
public class ViewController {
    ...
    private final AdvertisementFacade metaService;


    @GetMapping("/")
    public String index(Model model, Authentication authentication) {
        ViewModelUtils.setAuthenticationAttributes(model, authentication);
        return "index";
    }
    ...
    public String showAdvertisementDetailsPage(@RequestParam UUID id, Model model, Authentication authentication) {
        ViewModelUtils.setAuthenticationAttributes(model, authentication);
        setAdvertisementMetaData(id, model);
    ...
    private void setAdvertisementMetaData(UUID id, Model model) {
        MetaDataDTO metadata = metaService.getAdvertisementMetaDataById(id);
